...
// Updated sidebarLinks to include Video Performance
...
export function SidebarLink({ link, className }: SidebarLinkProps) {
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center gap-3 px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground",
        className
      )}
    >
      {link.icon}
